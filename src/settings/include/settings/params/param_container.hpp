#ifndef __SETTINGS__INCLUDE__SETTINGS__PARAMS__PARAM_CONTAINER_HPP__
#define __SETTINGS__INCLUDE__SETTINGS__PARAMS__PARAM_CONTAINER_HPP__
...
#endif   // __SETTINGS__INCLUDE__SETTINGS__PARAMS__PARAM_CONTAINER_HPP__