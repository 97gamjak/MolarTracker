...
namespace logging
{
    ...
    /**
     * @brief Construct a new Timed Log Entry Scope:: Timed Log Entry Scope
     * object
     *
     * This class extends LogEntryScope to also log the duration of the scope in
     * milliseconds when exiting the scope. It uses a steady clock to measure
     * the time difference between the construction and destruction of the
     * object.
     *
     * @param logObject The log object to use for logging entry and exit of the
