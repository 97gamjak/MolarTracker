#ifndef __CONTROLLER__SRC__CONTROLLER__SIDE_BAR_CATEGORY_CONTROLLER_HPP__
#define __CONTROLLER__SRC__CONTROLLER__SIDE_BAR_CATEGORY_CONTROLLER_HPP__
...
#endif   // __CONTROLLER__SRC__CONTROLLER__SIDE_BAR_CATEGORY_CONTROLLER_HPP__