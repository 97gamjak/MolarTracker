#ifndef __UI__INCLUDE__UI__POSITION__POSITION_TABLE_VIEW_HPP__
#define __UI__INCLUDE__UI__POSITION__POSITION_TABLE_VIEW_HPP__
...
#endif   // __UI__INCLUDE__UI__POSITION__POSITION_TABLE_VIEW_HPP__