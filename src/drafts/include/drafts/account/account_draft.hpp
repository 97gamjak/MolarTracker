#ifndef __DRAFTS__INCLUDE__DRAFTS__ACCOUNT__ACCOUNT_DRAFT_HPP__
#define __DRAFTS__INCLUDE__DRAFTS__ACCOUNT__ACCOUNT_DRAFT_HPP__
...
#endif   // __DRAFTS__INCLUDE__DRAFTS__ACCOUNT__ACCOUNT_DRAFT_HPP__