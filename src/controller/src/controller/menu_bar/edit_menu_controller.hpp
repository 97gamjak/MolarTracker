#ifndef __CONTROLLER__SRC__CONTROLLER__MENU_BAR__EDIT_MENU_CONTROLLER_HPP__
#define __CONTROLLER__SRC__CONTROLLER__MENU_BAR__EDIT_MENU_CONTROLLER_HPP__
...
#endif   // __CONTROLLER__SRC__CONTROLLER__MENU_BAR__EDIT_MENU_CONTROLLER_HPP__