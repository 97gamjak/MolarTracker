#ifndef __COMMON__INCLUDE__COMMON__RING_FILE_CONFIG_HPP__
#define __COMMON__INCLUDE__COMMON__RING_FILE_CONFIG_HPP__
...
#endif   // __COMMON__INCLUDE__COMMON__RING_FILE_CONFIG_HPP__