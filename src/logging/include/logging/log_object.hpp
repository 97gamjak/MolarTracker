#ifndef __LOGGING__INCLUDE__LOGGING__LOG_OBJECT_HPP__
#define __LOGGING__INCLUDE__LOGGING__LOG_OBJECT_HPP__
...
#endif   // __LOGGING__INCLUDE__LOGGING__LOG_OBJECT_HPP__