#ifndef __MAPPER__INCLUDE__MAPPER__TRANSACTION__TRANSACTION_MAPPER_HPP__
#define __MAPPER__INCLUDE__MAPPER__TRANSACTION__TRANSACTION_MAPPER_HPP__
...
#endif   // __MAPPER__INCLUDE__MAPPER__TRANSACTION__TRANSACTION_MAPPER_HPP__
