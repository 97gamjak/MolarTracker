#ifndef __UI__INCLUDE__UI__UTILS__DISCARD_CHANGES_HPP__
#define __UI__INCLUDE__UI__UTILS__DISCARD_CHANGES_HPP__
...
#endif   // __UI__INCLUDE__UI__UTILS__DISCARD_CHANGES_HPP__