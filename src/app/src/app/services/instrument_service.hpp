#ifndef __APP__INCLUDE__APP__SERVICES__INSTRUMENT_SERVICE_HPP__
#define __APP__INCLUDE__APP__SERVICES__INSTRUMENT_SERVICE_HPP__
...
#endif   // __APP__INCLUDE__APP__SERVICES__INSTRUMENT_SERVICE_HPP__