#ifndef __APP__INCLUDE__APP__STORE__PROFILE__PROFILE_STORE_HPP__
#define __APP__INCLUDE__APP__STORE__PROFILE__PROFILE_STORE_HPP__
...
#endif   // __APP__INCLUDE__APP__STORE__PROFILE__PROFILE_STORE_HPP__