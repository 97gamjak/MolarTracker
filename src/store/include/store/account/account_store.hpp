#ifndef __STORE__INCLUDE__STORE__ACCOUNT__ACCOUNT_STORE_HPP__
#define __STORE__INCLUDE__STORE__ACCOUNT__ACCOUNT_STORE_HPP__
...
#endif   // __STORE__INCLUDE__STORE__ACCOUNT__ACCOUNT_STORE_HPP__