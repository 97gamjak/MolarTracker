#ifndef __SETTINGS__INCLUDE__SETTINGS__PARAMS__PARAM_ERROR_HPP__
#define __SETTINGS__INCLUDE__SETTINGS__PARAMS__PARAM_ERROR_HPP__
...
#endif   // __SETTINGS__INCLUDE__SETTINGS__PARAMS__PARAM_ERROR_HPP__