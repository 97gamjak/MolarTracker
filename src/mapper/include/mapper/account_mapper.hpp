#ifndef __MAPPER__INCLUDE__MAPPER__ACCOUNT_MAPPER_HPP__
#define __MAPPER__INCLUDE__MAPPER__ACCOUNT_MAPPER_HPP__
...
#endif   // __MAPPER__INCLUDE__MAPPER__ACCOUNT_MAPPER_HPP__
