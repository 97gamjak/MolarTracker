#ifndef __COMMANDS__INCLUDE__COMMANDS__UPDATE_DEBUG_FLAGS_COMMAND_HPP__
#define __COMMANDS__INCLUDE__COMMANDS__UPDATE_DEBUG_FLAGS_COMMAND_HPP__
...
#endif   // __COMMANDS__INCLUDE__COMMANDS__UPDATE_DEBUG_FLAGS_COMMAND_HPP__