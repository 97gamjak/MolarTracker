#ifndef __UI__INCLUDE__UI__MENU_BAR__DEBUG_MENU_HPP__
#define __UI__INCLUDE__UI__MENU_BAR__DEBUG_MENU_HPP__
...
#endif   // __UI__INCLUDE__UI__MENU_BAR__DEBUG_MENU_HPP__