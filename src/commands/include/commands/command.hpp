#ifndef __COMMANDS__INCLUDE__COMMANDS__COMMAND_HPP__
#define __COMMANDS__INCLUDE__COMMANDS__COMMAND_HPP__
...
#endif   // __COMMANDS__INCLUDE__COMMANDS__COMMAND_HPP__