#ifndef __FINANCE__INCLUDE__FINANCE__TRANSACTION__BASE_TRANSACTION_HPP__
#define __FINANCE__INCLUDE__FINANCE__TRANSACTION__BASE_TRANSACTION_HPP__
...
#endif   // __FINANCE__INCLUDE__FINANCE__TRANSACTION__BASE_TRANSACTION_HPP__